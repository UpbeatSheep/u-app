...
public class Buildings extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			new getBuildings().execute(new URL(
					"http://www.omondo.co.uk/JSON/buildings.txt"));
	...
	private class getBuildings extends
			AsyncTask<URL, Integer, List<JSONObject>> {
